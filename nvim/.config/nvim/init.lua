...
require('packer').startup(function(use)
  ...
  use 'tpope/vim-repeat'                                                          -- Repeat support for various plugins
  ...
  use 'rafamadriz/friendly-snippets'                                              -- A snippet collectoin
...
-- Don't reset visual selection on indent
vim.keymap.set('v', '>', '>gv', { silent = true })
vim.keymap.set('v', '<', '<gv', { silent = true })

-- H start of the line, L end of the oline
...
--   command = "require('leap').init_highlight(true)",
--   group = leap_group,
-- })
